...
#pragma warning restore 0109
        ...
        public void FixedUpdate()
        {
            ...
            if (this.transform.rotation.y > 45 && this.transform.rotation.y < 135)
            {
                //will play with this some more but wanted to lock rotation to specific angles only
                 // rot = rigidbody.rotation * Quaternion.Euler(0, rotation * RotationSpeed * Time.fixedDeltaTime, 0);
            ...
            Vector3 forceUp = (rot * Vector3.forward) * acceleration * 1000.0f * MovementSpeed * Time.fixedDeltaTime;
            Vector3 forceLeft = (rot * Vector3.right) * rotation * 1000.0f * MovementSpeed * Time.fixedDeltaTime;
            rigidbody.AddForce(forceUp);
            rigidbody.AddForce(forceLeft);
