...
namespace Photon.Pun.Demo.Asteroids
{
    public class AsteroidsGameManager : MonoBehaviourPunCallbacks
    {
        ...
        public string CharacterName = "Spaceship";
        ...
        private void StartGame()
        {
            ...
            PhotonNetwork.Instantiate(CharacterName, position, rotation, 0);      // avoid this call on rejoin (ship was network instantiated before)
